        ...
        <div class="col-lg-3">
            ...
            <br>
              ...
              <div class="form-check">
                                    <input class="form-check-input" type="radio" name="pay_mode" value="Cash on Delivery" checked>
                                    <label class="form-check-label" for="cash On Delivery">Pay with Cash on Delivery</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="pay_mode" value="PayPal">
