    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                <a href="index.php" >
                    <span class="main-logo">JudithCafe</span>
                </a>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">Welcome to <i class="fa fa-utensils text-primary me-2"></i>Judith Cafe</h1>
                        <p class="mb-4">Judith Cafe began its journey from 2019 and has been one of the prominent restaurants in town ever since.Originally serving fast food in Brooklyn, Pretoria.
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>45 Brook Street, Brooklyn, Pretoria</p>
                        <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>012 548 7469</p>
                        <p class="mb-2"><i class="fa fa-envelope me-3"></i>info@judithcafe.com</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p>Sign up to receive out Newsletter.</p>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="#">JudthCafe</a>, All Right Reserved. 
