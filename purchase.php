    ...
    if(isset($_POST['purchase']))
    {
        ...
        if(mysqli_query($conn,$query1))
        {
            ...
            if($stmt)
            {
                ...
                ?>
                if ($_POST['pay_mode'] == 'Cash on Delivery') {
                    echo "<script>
                        /* alert('Please keep the order ammount ready for Cash on Delivery.'); */
                        window.location.href='success-onlpmt.php';
                        </script>";
                } elseif ($_POST['pay_mode'] == 'PayPal') {

                <form action="https://www.sandbox.paypal.com/cgi-bin/webscr/index.php" class="inputs" method="POST" name="form1" id="form1">
