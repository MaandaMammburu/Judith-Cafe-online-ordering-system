            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="mb-4">Judith Cafe began its journey from 2019 and has been one of the prominent restaurants in town ever since.Originally serving fast food in Dhaka,
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="#">Judith Cafe</a>, All Right Reserved. 
